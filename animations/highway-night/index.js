...
export default defineAnimation({
  ...
  files: [
    ...
    { path: "roadside.js", sub: "gantries and delineator posts",
      meta: "two more trains on the same lattice · one every other spacing, one every half" },
    ...
    { path: "skyline.js", sub: "towers at three depths, windows, beacons and housings",
      meta: "the tall group stands left of the vanishing point, and the right of it stays low" },
    { path: "backdrop.js", sub: "sky, stars, the pollution band and the city",
